; -------------------------------------------------------------------------
; Gelius - 08/07/2024 - Psychic Noise
; Psychic Noise deals Damage and prevents the target from healing. This move
; is a Sound Based Move.
; Based on Hecka-Bad's Boomburst.
; -------------------------------------------------------------------------
...
.definelabel TryInflictHealBlockStatus, 0x23185A8
...
;.definelabel TryInflictHealBlockStatus, 0x2319008
