; ------------------------------------------------------------------------------
; Gelius 12/3/2022 - Ceaseless Edge
; Ceaseless Edge does damage, a little fixed damage, and then places a trap
; below the target.
; Based on Hecka-Bad's Stone Axe (HEAVILY)
; ------------------------------------------------------------------------------
